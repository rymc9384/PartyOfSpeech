# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 15:08:43 2017
...
files = glob('./brown/*.htm')

# Extract text from Brown's pages:
def extract_html_11(file):
    
    ###########################################################################   
    # - PURPOSE: Extract text from Senator Brown's press release HTMLs.
    #
    # - ARGUMENT(S): 
...
def clean_text_11(text, rm_prepost=True, rm_quotes=False):
    
    ###########################################################################   
    # - PURPOSE: Clean text extracted from Brown's press releases.
    #
    # - ARGUMENT(S): 
