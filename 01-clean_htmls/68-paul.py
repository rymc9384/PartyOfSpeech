# -*- coding: utf-8 -*-
"""
Created on Wed Sep  6 12:03:54 2017
...
# Extract text from Paul's pages:
def extract_html_68(file):
    
    ###########################################################################   
    # - PURPOSE: Extract text from Senator Paul's press release HTMLs.
    #
    # - ARGUMENT(S): 
    ...
    if soup1 == None:
        soup = soup.find('div', {"id":"main_column"})
...
def clean_text_68(text, rm_prepost=True, rm_quotes=False):
    
    ###########################################################################   
    # - PURPOSE: Clean text extracted from Paul's press releases.
    #
    # - ARGUMENT(S): 
