# -*- coding: utf-8 -*-
"""
Created on Wed Aug 30 15:18:33 2017
...
files = glob('./franken/*.htm')

# Extract text from Franken's pages:
def extract_html_36(file):
    
    ###########################################################################   
    # - PURPOSE: Extract text from Senator Franken's press release HTMLs.
    #
    # - ARGUMENT(S): 
...
def clean_text_36(text, rm_prepost=True, rm_quotes=False):
    
    ###########################################################################   
    # - PURPOSE: Clean text extracted from Franken's press releases.
    #
    # - ARGUMENT(S): 
    ...
    if rm_prepost:
        ...
        # Doesn't have the dateline on most:
