# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 12:40:18 2017
...
files = glob('./blunt/*.htm')

# Extract text from Blunt's pages:
def extract_html_7(file):
    
    ###########################################################################   
    # - PURPOSE: Extract text from Senator Blunt's press release HTMLs.
    #
    # - ARGUMENT(S): 
...
def clean_text_7(text, rm_prepost=True, rm_quotes=False):
    
    ###########################################################################   
    # - PURPOSE: Clean text extracted from Blunt's press releases.
    #
    # - ARGUMENT(S): 
