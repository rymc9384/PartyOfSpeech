# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 10:15:44 2017
...
files = glob('./barrasso/*.htm')

# Extract text from Barrasso's pages:
def extract_html_3(file):
    
    ###########################################################################   
    # - PURPOSE: Extract text from Senator Barasso's press release HTMLs.
    #
    # - ARGUMENT(S): 
...
def clean_text_3(text, rm_prepost=True, rm_quotes=False):
    
    ###########################################################################   
    # - PURPOSE: Clean text extracted from Barrasso's press releases.
    #
    # - ARGUMENT(S): 
