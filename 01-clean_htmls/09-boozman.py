# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 14:03:59 2017
...
files = glob('./boozman/*.htm')

# Extract text from Boozman's pages:
def extract_html_9(file):
    
    ###########################################################################   
    # - PURPOSE: Extract text from Senator Boozman's press release HTMLs.
    #
    # - ARGUMENT(S): 
...
def clean_text_9(text, rm_prepost=True, rm_quotes=False):
    
    ###########################################################################   
    # - PURPOSE: Clean text extracted from Boozman's press releases.
    #
    # - ARGUMENT(S): 
